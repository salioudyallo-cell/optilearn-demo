...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Sauvegarde base de donnees uniquement : plus leger sur les inodes du
                    // mutualise. Le code est versionne (Git) et les assets sont regenerables
                    // ou stockables a part. Pour inclure les fichiers, ajouter storage_path('app').
                ],
        ...
        'destination' => [
             ...
             */
            'disks' => [
                // Disque local dedie ; ajouter un disque distant (S3/R2) via BACKUP_DISK
                // pour une copie hors serveur (recommande en production).
    ...
    'notifications' => [
        'notifications' => [
            // On ne notifie que les problemes : eviter un email quotidien de succes.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@opti-leads.com'),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            // Retention : on conserve toutes les sauvegardes pendant 14 jours (cahier).
